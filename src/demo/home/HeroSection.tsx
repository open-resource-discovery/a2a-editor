  ...
  return (
    <section className="flex flex-col items-center gap-6 px-6 py-20 text-center">
      ...
      <p className="max-w-2xl text-lg text-muted-foreground">
        Analyze, validate, and interact with Agent-to-Agent (A2A) protocol agent cards.
        Connect to agents, inspect their capabilities, and test communication in real-time.
      </p>
      <Link to="/playground">
